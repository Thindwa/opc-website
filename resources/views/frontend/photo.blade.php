@extends('layouts.frontend')
 ...
 <style>
    ...
    .banner-title {
        font-size: 1.8rem;
        /* Reduced from 2.5rem to medium size */
        font-weight: bold;
        margin-bottom: 1rem;
                ...
                <div class="col-12">
                    ...
                    <div class="row shuffle-wrapper gallery-grid">
                        ...
                        @foreach ($images as $image)
                            <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;gallery&quot;]">
                                <div class="project-img-container">
                                    <a class="gallery-popup" href="{{ $image->getUrl() }}">
                                        <img class="img-fluid" src="{{ $image->getUrl() }}" alt="Gallery image">
                                    ...
                                    <div class="project-item-info">
                                        <div class="project-item-info-content">
                                            <h5 class="project-item-title text-white">{{ $image->title ?? '' }}</h5>
